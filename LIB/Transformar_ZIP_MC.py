...
def Transformar_ZIP_MC(Directorio):
    ...
    for Zip in Zips:
        ...
        Diccionario_Tipo = {
            ...
            '19': 'FACTURA DE EXPORTACION',
            '20': 'NOTA DE DÉBITO POR OPERACIONES CON EL EXTERIOR',
            '21': 'NOTA DE CREDITO POR OPERACIONES CON EL EXTERIOR',
            '22': 'FACTURA - PERMISO EXPORTACION SIMPLIFICADO - DTO. 855/97',
            ...
            '37': 'NOTA DE DÉBITO O DOCUMENTO EQUIVALENTE QUE CUMPLAN CON LA R.G. N° 1415',
            '38': 'NOTA DE CRÉDITO O DOCUMENTO EQUIVALENTE QUE CUMPLAN CON LA R.G. N° 1415',
            ...
            '43': 'NOTA DE CRÉDITO LIQUIDACIÓN UNICA COMERCIAL IMPOSITIVA CLASE B',
            '44': 'NOTA DE CRÉDITO LIQUIDACIÓN UNICA COMERCIAL IMPOSITIVA CLASE C',
            '45': 'NOTA DE DÉBITO LIQUIDACIÓN UNICA COMERCIAL IMPOSITIVA CLASE A',
            '46': 'NOTA DE DÉBITO LIQUIDACIÓN UNICA COMERCIAL IMPOSITIVA CLASE B',
            '47': 'NOTA DE DÉBITO LIQUIDACIÓN UNICA COMERCIAL IMPOSITIVA CLASE C',
            '48': 'NOTA DE CRÉDITO LIQUIDACIÓN UNICA COMERCIAL IMPOSITIVA CLASE A',
            ...
            '89': 'RESUMEN DE DATOS',
            '90': 'OTROS COMPROBANTES - DOCUMENTOS EXCEPTUADOS - NOTA DE CRÉDITO',
            '91': 'REMITOS R',
